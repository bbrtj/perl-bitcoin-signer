...
my $utxo = btc_utxo->new(
	txid => [hex => '87c29f81ba96c49ef5299c14074f3c82fd0e455ebe80efc10cf69cc440fa64a1'],
	output_index => 0,
	output => {
		locking_script => [
			address =>
...
$tx->add_output(
	locking_script =>
		[address => $this_key->derive_key_bip44(get_from_account => true)->get_basic_key->get_public_key->get_address],
	value => $value_sent,
);
